 ...
 * Avoir
 *
 * @ORM\Table(name="AVOIR", indexes={@ORM\Index(name="WDIDX16334215683", columns={"IDCONTACT"}), @ORM\Index(name="WDIDX163342156916", columns={"CLE_MACHINE_CIBLE"}), @ORM\Index(name="WDIDX16334215680", columns={"IDDELPMT"}), @ORM\Index(name="WDIDX163342156813", columns={"IDIMPUTATION"}), @ORM\Index(name="CC_IDORIGCRE", columns={"IDORIG", "DHCRE"}), @ORM\Index(name="WDIDX163342156810", columns={"VILLE"}), @ORM\Index(name="WDIDX16334215687", columns={"DT_ECHEANCE"}), @ORM\Index(name="CC_CT_STAT", columns={"IDCONTACT", "STATUT_FAD"}), @ORM\Index(name="WDIDX16334215684", columns={"DT_MULTI"}), @ORM\Index(name="WDIDX163342156917", columns={"CLE_PIECE_ORIG"}), @ORM\Index(name="WDIDX16334215681", columns={"DT_FACTURE"}), @ORM\Index(name="WDIDX163342156914", columns={"IDPROJET"}), @ORM\Index(name="WDIDX163342156811", columns={"STATUT_FAD"}), @ORM\Index(name="CC_NUM_DT", columns={"IDFACTURE", "DT_FACTURE"}), @ORM\Index(name="WDIDX16334215688", columns={"NOM_CLIENT"}), @ORM\Index(name="WDIDX16334215685", columns={"DHCRE"}), @ORM\Index(name="CC_CT_ID", columns={"IDCONTACT", "IDFACTURE"}), @ORM\Index(name="WDIDX16334215682", columns={"MTT_TOTAL_TTC"}), @ORM\Index(name="WDIDX163342156915", columns={"IDTACHE"}), @ORM\Index(name="WDIDX163342156812", columns={"REFORIG"}), @ORM\Index(name="WDIDX16334215689", columns={"RAISON_SOCIALE"}), @ORM\Index(name="CC_DT_NUM", columns={"DT_FACTURE", "IDFACTURE"}), @ORM\Index(name="WDIDX16334215686", columns={"NATURE"})})
 * @ORM\Entity
 */
#[ApiResource]
class Avoir
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_FACTURE", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtFacture = 'NULL';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_MULTI", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtMulti = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="NATURE", type="string", length=100, nullable=true, options={"default"="''"})
     */
    private $nature = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="LIB_REMISE", type="string", length=50, nullable=true, options={"default"="''"})
     */
    private $libRemise = '\'\'';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_ECHEANCE", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtEcheance = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NOTE_COMPLEMENT", type="text", length=0, nullable=true, options={"default"="NULL"})
     */
    private $noteComplement = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NOM_CLIENT", type="string", length=80, nullable=true, options={"default"="''"})
     */
    private $nomClient = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="CDPAYS", type="string", length=3, nullable=true, options={"default"="''"})
     */
    private $cdpays = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="VREF", type="string", length=50, nullable=true, options={"default"="''"})
     */
    private $vref = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="REFEXTERNE", type="string", length=50, nullable=true, options={"default"="''"})
     */
    private $refexterne = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="NOTE_HISTORIQUE", type="text", length=0, nullable=true, options={"default"="NULL"})
     */
    private $noteHistorique = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="TRANSPORTEUR", type="string", length=100, nullable=true, options={"default"="''"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="REFORIG", type="string", length=10, nullable=true, options={"default"="''"})
     */
    private $reforig = '\'\'';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_EXPORT", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtExport = 'NULL';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_DERNIER_RAPPEL", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtDernierRappel = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="CLE_MACHINE_CIBLE", type="string", length=12, nullable=true, options={"default"="''"})
     */
     ...
     * @var int|null
     *
     * @ORM\Column(name="IDDOCUMENT", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $iddocument = NULL;

    /**
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_COMPTA", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtCompta = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="CLE_PIECE_ORIG", type="string", length=10, nullable=true, options={"default"="''"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="NOTE_AVANT", type="text", length=0, nullable=true, options={"default"="NULL"})
     */
    private $noteAvant = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NOTE_APRES", type="text", length=0, nullable=true, options={"default"="NULL"})
     */
    private $noteApres = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NOTE_PIECE", type="text", length=0, nullable=true, options={"default"="NULL"})
     */
    private $notePiece = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="INCOTERM", type="string", length=3, nullable=true, options={"default"="''"})
     */
    private $incoterm = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="LIB_TRSPT", type="string", length=30, nullable=true, options={"default"="''"})
     */
    private $libTrspt = '\'\'';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_AVANCEMENT", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtAvancement = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="US_TECH", type="string", length=3, nullable=true, options={"default"="''"})
     */
    private $usTech = '\'\'';
     ...
     * @var string|null
     *
     * @ORM\Column(name="SIGNATURE_CLT", type="blob", length=0, nullable=true, options={"default"="NULL"})
     */
    private $signatureClt = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="SIGNATURE_TECH", type="blob", length=0, nullable=true, options={"default"="NULL"})
     */
    private $signatureTech = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="NUMTRACKING", type="string", length=24, nullable=true, options={"default"="''"})
     */
    private $numtracking = '\'\'';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="DT_EXPED", type="date", nullable=true, options={"default"="NULL"})
     */
    private $dtExped = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="INFOTECH", type="string", length=80, nullable=true, options={"default"="NULL"})
     */
    private $infotech = 'NULL';
